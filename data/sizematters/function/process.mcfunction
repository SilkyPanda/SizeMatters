...
execute if entity @s[type=ender_dragon] store result storage sizematters:macro scale double 0.01 run random value 180..220
...
execute if entity @s[type=spider] if score @s scale_group matches 2 store result storage sizematters:macro scale double 0.01 run random value 10..30
execute if entity @s[type=spider] if score @s scale_group matches 3 store result storage sizematters:macro scale double 0.01 run random value 25..35
...
execute if entity @s[type=cave_spider] if score @s scale_group matches 2 store result storage sizematters:macro scale double 0.01 run random value 10..30
execute if entity @s[type=cave_spider] if score @s scale_group matches 3 store result storage sizematters:macro scale double 0.01 run random value 25..35
